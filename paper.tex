...
simple arbiter system in which the environment requests for either 1 or 0
resources, and the controller may grant access to two resources. The controller
must ensure that the number of unhandled requests is not $\geq 2$.
...
\begin{figure}
    \begin{subfigure}[t]{\textwidth}
        ...
        \begin{tabular}{l | l | l}
            ...
            \hline
            \texttt{request = \{0, 1\}} & \texttt{grant0 = \{0, 1\}} & \texttt{resource0 = \{0, 1\}} \\
        ...
        \begin{tikzpicture}[dash pattern = on 2pt off 2pt, level distance = 10mm]
            \node [circle,draw] (root){}
                child {node [circle,draw] {}
                    child {node [circle,draw] {}
                        edge from parent [fixed] node [left] {\texttt{req=0}}
                    }
                    edge from parent [fixed] node [left] {\texttt{req=0}}
                }
%%%                child {node [circle,draw] {}
        ...
        \begin{tikzpicture}[dash pattern = on 2pt off 2pt, level distance = 10mm]
            \node [circle,draw] (root){}
                child {node [circle,draw] {}
                    ...
                    child {node [circle,draw] {}
                        edge from parent [fixed] node [right] {\texttt{req=1}}
                    }
                    edge from parent [fixed] node [left] {\texttt{req=0}}
                }
                node [above=4pt] {$\langle s, k \rangle$};
