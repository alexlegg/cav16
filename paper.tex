...
hard for BDD solvers. This example illustrates the strength of the approach
presented here, which does not need to enumerate all winning states as will be
shown in Section~3.
