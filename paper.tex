...
makes the problem hard for BDD solvers. In Section~3 we will outline how this
example can be solved without enumerating all winning states.
...
\begin{exmpI}
    ...
    environment. This conjecture is captured in the abstract game tree show in
...
\begin{exmpInt}
    ...
    to compute an interpolant from the proof of unsatisfiability of a SAT
    solver.
